...
import com.independentsoft.exchange.ReplyAllItem;
    ...
    public static void main(String[] args)
    {
        try
        {
            ...
            for (int i = 0; i < findItemResponse.getItems().size(); i++)
            {
                ...
                ReplyAllItem replyItem = new ReplyAllItem(currentMessageId);
                replyItem.setNewBody(replyBody);

                ItemInfoResponse response = service.replyToAll(replyItem);
            }
        }
